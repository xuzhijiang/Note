...
//注解处理器能支持的注解类型,对应getSupportedAnnotationTypes()方法
@SupportedAnnotationTypes({"org.java.core.base.annotations.processor.VersionCheckAnnotation"})
//注解处理器支持的Java版本,对应getSupportedSourceVersion()这个方法
