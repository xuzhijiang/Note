...
public class Math {
    ...
    // static静态变量也是存放在方法区的
    // new Object()存放在堆中，obj这个静态变量是存放在方法区，这个也就是方法区和堆的关联
    public static Object obj = new Object();
    // new Object()这个对象包含了对象头，对象头中有一个叫Klass pointer(类型指针)的，
    // 就是指向方法区中的类元信息，也就是把
    // Object.class在方法区中的类元信息的具体地址存放在了堆中new Object()对象中的Klass pointer中。
