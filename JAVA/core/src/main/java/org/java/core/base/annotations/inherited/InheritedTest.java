...
public class InheritedTest {
    ...
    public static void main(String[] args) throws SecurityException, NoSuchMethodException {
        ...
        if(method4.isAnnotationPresent(MyAnnotation.class)){
            ...
            System.out.println("子类实现了接口的的doSomething方法，继承到了接口的doSomething方法中的Annotation,其信息如下："+annotation.value());
        }else{
            System.out.println("子类实现了接口的的doSomething方法，没有继承到了接口的doSomething方法中的Annotation");
        }
    }
