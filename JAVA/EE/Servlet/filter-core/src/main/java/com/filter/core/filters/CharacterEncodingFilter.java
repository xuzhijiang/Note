...
/**
 * 这里的代码,不要再用了,了解这个解决思路即可
 */
@WebFilter(urlPatterns = "/test-encoding")
public class CharacterEncodingFilter implements Filter {
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        System.out.println("CharacterEncodingFilter进行过滤***********");
        ...
        Object proxyRequest = Proxy.newProxyInstance(
                ...
                new InvocationHandler() { /*InvocationHandler，采用匿名内部类的方式*/
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        // 本例中: 乱码的根源在于调用HttpServletRequest.getParameter()，所以我们只盯着这个方法
