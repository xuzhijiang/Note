...
public class AnnotationConfigServletWebServerApplicationContext
     ...
     * other definitions from the given annotated classes and automatically refreshing the
     * context.
     ...
     * for other definitions in the given packages and automatically refreshing the
     * context.
     ...
     * @param beanNameGenerator the other name generator
    ...
    /**
     * Set the {@link ScopeMetadataResolver} to use for detected other classes.
     * <p>
