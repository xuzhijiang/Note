package com.spring.autoconfiguration.component;
...
public class MyImportSelector implements ImportSelector {
    ...
    protected List<String> getCandidateConfigurations() {
        // 第一个参数: 加载的类型,也就是MyEnableAutoConfig.class
        ...
        // 封装成LinkedMultiValueMap<com.spring.autoconfiguration.config.SpringRedisConfig, com.spring.autoconfiguration.component.MyEnableAutoConfig>
        // 注意: com.spring.autoconfiguration.component.MyEnableAutoConfig是这个LinkedMultiValueMap的key,
        // com.spring.autoconfiguration.component.MyEnableAutoConfig是value.这个设计很巧妙
