...
public class SpringApplication {
    ...
    public ConfigurableApplicationContext run(String... args) {
        ...
        spring.source.SpringApplicationRunListeners listeners = getRunListeners(args);
    ...
    private ConfigurableEnvironment prepareEnvironment(spring.source.SpringApplicationRunListeners listeners,
    ...
    private void prepareContext(ConfigurableApplicationContext context,
                                ConfigurableEnvironment environment, spring.source.SpringApplicationRunListeners listeners,
    ...
    private spring.source.SpringApplicationRunListeners getRunListeners(String[] args) {
        Class<?>[] types = new Class<?>[]{org.springframework.boot.SpringApplication.class, String[].class};
        return new spring.source.SpringApplicationRunListeners(logger, getSpringFactoriesInstances(
    ...
    protected void load(ApplicationContext context, Object[] sources) {
        ...
        spring.source.BeanDefinitionLoader loader = createBeanDefinitionLoader(
    ...
    /**
     * Get the other definition registry.
     *
     * @param context the application context
    ...
    /**
     * Factory method used to create the {@link spring.source.BeanDefinitionLoader}.
     *
     * @param registry the other definition registry
     * @param sources  the sources to load
     * @return the {@link spring.source.BeanDefinitionLoader} that will be used to load beans
     */
    protected spring.source.BeanDefinitionLoader createBeanDefinitionLoader(
            BeanDefinitionRegistry registry, Object[] sources) {
        return new spring.source.BeanDefinitionLoader(registry, sources);
    }
    ...
    private void handleRunFailure(ConfigurableApplicationContext context, Throwable exception,
                                  ...
                                  spring.source.SpringApplicationRunListeners listeners) {
        if (listeners != null) {
