...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
    ...
    public void refresh() throws BeansException, IllegalStateException {
        ...
        synchronized (this.startupShutdownMonitor) {
            ...
            // Tell the subclass to refresh the internal other factory.
            ConfigurableListableBeanFactory beanFactory = obtainFreshBeanFactory();

            // Prepare the other factory for use in this context.
            prepareBeanFactory(beanFactory);

            try {
                // Allows post-processing of the other factory in context subclasses.
                ...
                // Register other processors that intercept other creation.
                ...
                // Reset CommonSource introspection caches in Spring's core, since we
    ...
    protected void prepareBeanFactory(ConfigurableListableBeanFactory beanFactory) {
        ...
        // Tell the internal other factory to use the context's class loader etc.
        ...
        // Configure the other factory with context callbacks.
        beanFactory.addBeanPostProcessor(new spring.source.ApplicationContextAwareProcessor(this));
        ...
        // MessageSource registered (and found for autowiring) as a other.
        ...
        beanFactory.addBeanPostProcessor(new spring.source.ApplicationListenerDetector(this));
    ...
    protected void invokeBeanFactoryPostProcessors(ConfigurableListableBeanFactory beanFactory) {
        ...
        spring.source.PostProcessorRegistrationDelegate.invokeBeanFactoryPostProcessors(beanFactory, getBeanFactoryPostProcessors());
    ...
    /**
     * 实例化并调用所有已注册的BeanPostProcessor other，
     * 如果给予顺序的话，要遵循显示的顺序.
    ...
    protected void registerBeanPostProcessors(ConfigurableListableBeanFactory beanFactory) {
        ...
        // 这些BeanPostProcessor会在这个方法内被实例化(通过调用BeanFactory的getBean方法，如果没有找到实例化的类，就会去实例化)。
         spring.source.PostProcessorRegistrationDelegate.registerBeanPostProcessors(beanFactory, this);
    }
    ...
    /**
     * Finish the initialization of this context's other factory,
    ...
    protected void finishBeanFactoryInitialization(ConfigurableListableBeanFactory beanFactory) {
        ...
        // Register a default embedded value resolver if no other post-processor
        // (such as a PropertyPlaceholderConfigurer other) registered any before:
        ...
        // Allow for caching all other definition metadata, not expecting further changes.
    ...
    /**
     * Reset Spring's CommonSource reflection metadata caches, in particular the
    ...
    /**
     * Close this application context, destroying all beans in its other factory.
     * <p>Delegates to {@code doClose()} for the actual closing procedure.
     ...
     * destroys the singletons in the other factory of this application context.
     ...
     * "destroy-method".
     * <p>Can be overridden to add context-specific other destruction steps
     ...
     * on an active context, i.e. in particular all other accessor methods.
