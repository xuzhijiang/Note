...
public class RestDemoApplicationTests {
    ...
    @Autowired
    private WebApplicationContext context;    // 自动注入WebApplication上下文对象

    private MockMvc mockMvc;    // 用于测试Spring Boot的控制器

    @Before
    public void setup(){
        // 构建虚拟MVC环境(mock: 虚假的意思)
    ...
    public void testQueryArgument() throws Exception {
        ...
        String result= mockMvc.perform(MockMvcRequestBuilders.get("/myservice/query")
