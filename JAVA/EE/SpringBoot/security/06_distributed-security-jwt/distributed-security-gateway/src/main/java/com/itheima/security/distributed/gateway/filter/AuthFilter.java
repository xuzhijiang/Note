...
// 网关进行令牌解析并转发当前登录用户信息（明文token）给微服务
public class AuthFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException {
        ...
        // 所有请求网关的令牌一定要是oauth2.0的格式,所以这里判断下,如果它不是oauth2.0的格式的令牌,我们就不对它进行解析
        // 如果是OAuth2.0的格式再进行解析
        ...
        // 很有可能令牌中还有其他信息,所以我们要把其他信息也要取出来,然后一起传给微服务
        ...
        // spring也自带了base64的相关工具类:  org.springframework.util.Base64Utils
