...
JMS定义了Java API层面的标准，在java体系中，多个客户端 均可以使用JMS进行交互，不需要修改代码，对跨平台支持性较差。AMPQ定义了协议标准，天然具有跨平台，跨语言的特性。
...
RabbitMQ是一个由erlang开发的AMQP(Advanved Message Queue Protocol)的开源实现,它可以支持多种操作系统，多种编程语言，几乎可以覆盖所有主流的企业级技术平台。
