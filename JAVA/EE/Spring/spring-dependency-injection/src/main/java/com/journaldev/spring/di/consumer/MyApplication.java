...
// a consumer class for MessageService. 
// with Spring annotations for autowiring(自动装配的Spring注释)
...
//	For our example, I am using method-based dependency injection. 
	//You can uncomment the constructor method to switch to constructor
	//based dependency injection.
//	对于我们的示例，我使用基于方法的依赖注入。 您可以取消注释构造函数方法以
	//切换到基于构造函数的依赖项注入。
