 ...
 * Java synchronization works on locking and unlocking of resource, 
 ...
 * in wait state to lock the synchronized resource.
 * <p><br>
 ...
 * so it’s always best practice to use synchronized block to 
 ...
 * and you might have to look after some global locking mechanism.
 ...
 * block, so that it’s reference can’t be changed by any other code.
 ...
 * if any other code is also locking on same String, it will try 
 * to acquire lock on the same reference object from String pool 
